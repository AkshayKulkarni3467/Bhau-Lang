...
//     int param_count = 0;
//     //TODO handle the TYPE_PARAM
//     while(instr->op != TAC_FUNC_END){
//         switch(instr->op){
//             case TAC_PARAM : {
//                 //WARN Cannot pass a float value directly in a argument
//                 param_count++;
//                 switch(param_count){
//                     case 1:
//                         fprintf(fp,"    mov QWORD [rbp - %d], rdi\n",get_offset(table,instr->arg1->val.sval));
//                         break;
//                     case 2:
//                         fprintf(fp,"    mov QWORD [rbp - %d], rsi\n",get_offset(table,instr->arg1->val.sval));
//                         break;
//                     case 3:
//                         fprintf(fp,"    mov QWORD [rbp - %d], rdx\n",get_offset(table,instr->arg1->val.sval));
//                         break;
//                     case 4:
//                         fprintf(fp,"    mov QWORD [rbp - %d], rcx\n",get_offset(table,instr->arg1->val.sval));
//                         break;
//                     case 5:
//                         fprintf(fp,"    mov QWORD [rbp - %d], r8\n",get_offset(table,instr->arg1->val.sval));
//                         break;
//                     case 6:
//                         fprintf(fp,"    mov QWORD [rbp - %d], r9\n",get_offset(table,instr->arg1->val.sval));
//                         break;
//                     default:
//                         //WARN Check this default again if it is working properly or not for stack spill 
//                         fprintf(fp,"    mov rax, QWORD [rbp + %d]\n"
//                                    "    mov QWORD [rbp - %d], rax\n",8*(param_count - 7),get_offset(table,instr->arg1->val.sval));
//                 }
//                 break;
//             }
//             case TAC_RETURN: {
            ...
            case TAC_UNOP: {
                if(strcmp(instr->relop->operator_str,"!") == 0){
                    if(get_offset(slist,instr->arg1->val.sval,instr->arg1->scope_id)){
                        ...
                        //TODO
                        fprintf(stderr,"Unary ops for global not implemented\n");
                        exit(1);
                    }
                }else if(strcmp(instr->relop->operator_str,"-") == 0){
                    if(get_offset(slist,instr->arg1->val.sval,instr->arg1->scope_id)){
